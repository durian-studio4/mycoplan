...
const SelectRecipeKategoriComponent: React.FC<Props> = ({ initial, disabled, handleChange }) => {
  ...
  return (
    <Select
      labelInValue
      defaultValue={{ key: initial || 'Mohon Pilih Kategori Resep' }}
      style={{
        width: '100%',
        minHeight: '2em',
      }}
...
export default SelectRecipeKategoriComponent;
