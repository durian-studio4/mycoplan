  ...
  <Row gutter={24} type="flex">
    ...
    <Col {...topColResponsiveProps}>
      <ChartCard
        bordered={false}
        title={
          <FormattedMessage id="total-pengguna-facebook" defaultMessage="Total Pengguna Facebook" />
        }
    ...
    <Col {...topColResponsiveProps}>
      <ChartCard
        bordered={false}
        title={<FormattedMessage id="total-pengguna-email" defaultMessage="Total Pengguna Email" />}
