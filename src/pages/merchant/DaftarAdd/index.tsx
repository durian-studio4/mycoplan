...
import { Card, Row, Input, Button, TimePicker, Checkbox, Upload } from 'antd';
...
const DaftarAddComponent: React.FC<Props> = () => {
  return (
    <div>
      <p className={styles.title}>Tambah Merchant</p>
      <Card>
...
export default DaftarAddComponent;
