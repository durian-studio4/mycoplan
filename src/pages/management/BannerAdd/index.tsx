...
import { Card, Row, Input, Button, TimePicker, DatePicker, Upload } from 'antd';
...
const ManagementBannerAddComponent: React.FC<Props> = () => {
  return (
    <div>
...
export default ManagementBannerAddComponent;
